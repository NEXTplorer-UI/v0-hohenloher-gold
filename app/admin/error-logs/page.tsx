  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Fehler-Logs & Benachrichtigungen</h1>
          <p className="text-muted-foreground">Überwachung von Systemfehlern und ausstehenden Aufgaben</p>
        </div>
                    ...
                    <div className="flex items-start justify-between">
                      <div>
                        <CardTitle className="text-lg">
                          {email.type === "order_confirmation" ? "Bestellbestätigung" : email.type}
                        </CardTitle>
                        <CardDescription className="flex items-center gap-2 mt-1">
