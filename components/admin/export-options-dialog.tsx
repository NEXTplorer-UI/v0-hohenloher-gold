        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            ...
            <RadioGroup value={format} onValueChange={(value) => setFormat(value as ExportOptions["format"])}>
              ...
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="picking-list" id="format-picking-list" />
                <Label htmlFor="format-picking-list" className="font-normal cursor-pointer">
                  Kommissionierliste (nach Abholort → Verteilperson → Produkte)
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="packing-list" id="format-packing-list" />
                <Label htmlFor="format-packing-list" className="font-normal cursor-pointer">
                  Packliste pro Verteilperson (kompakt, ohne Unterschriften)
                </Label>
              </div>
            </RadioGroup>
          </div>
