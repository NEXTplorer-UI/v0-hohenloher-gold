-- Add address fields to get_admin_orders RPC function
-- This ensures the admin orders export includes customer addresses
...
BEGIN
  ...
  SELECT
    ...
    o.created_at,
    o.qr_code_url,
    -- Added address fields to customer JSONB object
    jsonb_build_object(
