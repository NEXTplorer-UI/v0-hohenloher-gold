-- Fix product_availability view to read from correct tables
-- Drop and recreate the view with correct logic and dynamic thresholds

-- Drop materialized view and create regular view instead for real-time data
DROP MATERIALIZED VIEW IF EXISTS product_availability CASCADE;
...
SELECT 
  ...
  CASE 
    ...
    ELSE
      CASE 
        -- Fixed column name from min_stock_quantity to min_stock
