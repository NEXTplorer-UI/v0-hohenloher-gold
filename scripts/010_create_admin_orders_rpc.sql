-- ============================
-- Postgres RPC: get_admin_orders
-- Liefert verschachtelte Struktur mit customer{} und order_items[]
-- SECURITY DEFINER um RLS zu umgehen
-- ============================
...
'Admin-Orders für CRM-UI (verschachtelte Struktur: customer{}, order_items[]). SECURITY DEFINER um RLS zu umgehen.';
