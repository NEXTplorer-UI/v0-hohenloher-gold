-- Add customer special_requests to admin_orders_search RPC
-- So the customer info banner in order cards can display customer information
...
BEGIN
  ...
  WITH filtered_orders AS (
    SELECT 
      ...
      c.special_requests AS customer_special_requests
